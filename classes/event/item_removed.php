...
/**
 * The block_stash item removed event
 *
 * @package    block_stash
 ...
 *      - string removaltype: Whether the removal was through a trade, teacher reset, or something else.
 * }
 *
 * @package    block_stash
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class item_removed extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->userid' helped the user '$this->relateduserid' to remove an item with
                the id '$this->objectid' with the quantity of '" . $this->other['quantity'] . "' through
                '" . $this->other['removaltype'] . "'.";
    }
    ...
    public static function get_name() {
        return get_string('eventitemremoved', 'block_stash');
    }
    ...
    protected function validate_data() {
        ...
        if (!isset($this->other['removaltype'])) {
            throw new \coding_exception('The \'removaltype\' must be set.');
        }
    }
}
